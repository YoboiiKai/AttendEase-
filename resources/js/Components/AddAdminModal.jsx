...
export default function AddAdminModal({ isOpen, onClose, onAdminsUpdate }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post('api/admin/admin', formData, {
        headers: { 
      ...
      if (response.data.success) {
        ...
        Swal.fire(
          'Error',
          response.data.message || 'Failed to add admin',
          'error'
        );
      }
    } catch (error) {
