...
export default function UpdateSecretaryModal({ isOpen, onClose, secretaryData, onSecretariesUpdate }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.put(`api/admin/secretary/${secretaryData.id}`, formData, {
        headers: { 
      ...
      if (response.data.success) {
        Swal.fire('Success', 'Secretary updated successfully', 'success');
        onClose();
      ...
      if (error.response?.data?.errors) {
        ...
        Swal.fire(
          'Error',
          error.response?.data?.message || 'Failed to update secretary',
          'error'
        );
      }
    }
