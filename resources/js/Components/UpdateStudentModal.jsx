...
import { X, User, Hash, Calendar, Users, CreditCard, Mail, Lock, Image, QrCode, Eye, EyeOff, Fingerprint } from 'lucide-react'
import ReactQRCode from 'react-qr-code'
import Swal from "sweetalert2"
import axios from 'axios'

export default function UpdateStudentModal({ isOpen, onClose, studentId, onStudentsUpdate }) {
    ...
    const fetchStudentData = async () => {
        try {
            ...
            if (student.image) {
                setImagePreview(`/storage/${student.image}`);
            }
            if (student.qrcode) {
                setQrCodeData(student.qrcode);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.post(`api/admin/student/${studentId}`, formDataToSend, {
                headers: { 
