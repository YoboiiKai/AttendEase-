...
export default function SecreatryLayout({children }) {
    ...
    return (
        <div className="flex h-screen bg-green-950">
                        ...
                        <details>
                            ...
                            <div className="pl-7 mt-2 bg-green-900/20">
                                <MenuItem
                                    icon={MessageSquare}
                                    text="Dress Code"
                                    href="/secretary/addfines"
                                />
                                <MenuItem
                                    icon={Calendar}
                                    text="Absences"
                                    href="/secretary/absences"
                                />
                            </div>
                        </details>
                    </div>
            ...
            <div className="flex flex-col flex-1 overflow-hidden">
                {/* Header */}
                <header className="bg-gradient-to-l from-green-900 to-green-800 shadow-lg py-4 px-6 flex items-center justify-between border-b border-green-800/30">
                    <button
                    ...
                    <div className="relative ml-auto">
                        ...
                        {/* Dropdown Menu */}
                        {isDropdownOpen && (
                            <div className="absolute right-0 mt-2 w-48 py-2 bg-green-900 rounded-md shadow-lg border border-green-800/30 z-50">
                                <div className="px-4 py-3 border-b border-green-800/30">
                                    ...
                                    <p className="text-sm font-semibold text-white text-center">{user.name}</p>
                                </div>
                                <Link
                                    href={route('logout')}
                                    method="post"
                ...
                {/* Main Content Area */}
                <main className="flex-1 overflow-x-hidden overflow-y-auto bg-white p-6 relative z-30">
                        {/* Background Icons */}
