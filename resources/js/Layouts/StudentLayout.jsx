            ...
            <div className="flex flex-col flex-1 overflow-hidden">
                ...
                <header className="bg-gradient-to-l from-green-900 to-green-800 shadow-lg py-4 px-6 flex items-center justify-between border-b border-green-800/30">
                    ...
                    <div className="relative ml-auto">
                        ...
                        {/* Dropdown Menu */}
                        {isDropdownOpen && (
                            <div className="absolute right-0 mt-2 w-48 py-2 bg-green-900 rounded-md shadow-lg border border-green-800/30 z-40">
                                <div className="px-4 py-3 border-b border-green-800/30">
                                    ...
                                    <p className="text-xs text-green-300 text-center truncate">{user.email}</p>
                                </div>
                                <Link
                                    href={route('logout')}
                                    method="post"
